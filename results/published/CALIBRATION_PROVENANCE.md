...
| `2026-09-09-nvidia_h200-gaps-session` | session | n/a | n/a | n/a | **refused** |
...
| `2026-09-25-nvidia_a100_sxm4_40gb-r3-counters` | session | n/a | n/a | n/a | **refused** |
| `2026-09-25-nvidia_gh200_480gb-session` | session | n/a | n/a | n/a | **refused** |
| `2026-09-25-nvidia_h100_80gb_hbm3-session` | session | n/a | n/a | n/a | **refused** |

**18 of 22 arms pass**: their calibration is either their own or declared derived. 4 does not.
...
- 2026-09-09-nvidia_h200-gaps-session: rows carry 0 dtypes [], so there is no single ridge; pass one

- 2026-09-10-nvidia_h200-gaps-session: rows carry 0 dtypes [], so there is no single ridge; pass one
...
- 2026-09-25-nvidia_a100_sxm4_40gb-r3-counters: rows carry 0 dtypes [], so there is no single ridge; pass one

- 2026-09-25-nvidia_gh200_480gb-session: rows carry 0 dtypes [], so there is no single ridge; pass one

- 2026-09-25-nvidia_h100_80gb_hbm3-session: rows carry 0 dtypes [], so there is no single ridge; pass one
