# alpha by ablation, without the byte model   (1833c29)
...
ceilings: measured_nvidia_h200.yaml, read roof 4470 GB/s, L2 60.0 MiB
...
## what this costs
  ...
  WALL     13.0 min   the KERNEL figure at the one measured wall-over-kernel ratio in
