...
#     chain run R3 at one duty. Session 4's three ratio pages were INVALID on
#     V7 at full duty, the power cap boosting whichever arm read fewer bytes
#     (2% at G=1, 18% at G=16), and `private_duty` says why the duty is 0.25
